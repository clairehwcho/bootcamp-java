...
public class UserController {
	...
	// ----- ACTIONS -----
	// REGISTER
	// Pass the object filled with the form data from the view model into the post
	// method
	// Use the result variable which collects information about the object to handle
	// error
